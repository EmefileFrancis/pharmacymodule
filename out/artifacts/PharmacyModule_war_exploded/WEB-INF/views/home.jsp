        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <!-- ============================================================== -->
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-dark" href="#"><img src="<c:url value="/images/profilepics/d4.jpg"/>" alt="user" class="profile-pic" /></a>
                    </li>
                </ul>
            </div>
        </nav>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-20">
                                <table class="table vm no-th-brd no-wrap pro-of-month">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td style="width:50px;"><span class="round"><img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" width="50"></span></td>
                                        <td>
                                    ...
                                    <tr class="active">
                                        <td><span class="round"><img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" width="50"></span></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><span class="round round-success"><img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" width="50"></span></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><span class="round round-primary"><img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" width="50"></span></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><span class="round round-warning"><img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" width="50"></span></td>
                                        <td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="message-box contact-box">
                                <div class="message-widget contact-widget">
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"> <img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Pavan kumar</h5> <span class="mail-desc">info@wrappixel.com</span></div>
                                    </a>
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"> <img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                        <div class="mail-contnet">
                                    ...
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"> <img src="<c:url value="resources/images/profilepics/d4.jpg"/>" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                        <div class="mail-contnet">
