            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-plus-square" aria-hidden="true"></i>Add New Practitioner</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Practitioner</li>
            </ol>
        </section>
                    ...
                    <div class="panel panel-default chartJs">
                        <div class="panel-heading">
                            <div class="card-title">
                                <div class="title">Add New Practioner</div>
                            </div>
                        </div>
                            ...
                            <form action="<c:url value="#"/>" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="practitioner">Practice</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="institutionType">
                                            <c:forEach items="${institutionTypes}" var="institutionType">
                                                <option>${institutionType.type_Name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
