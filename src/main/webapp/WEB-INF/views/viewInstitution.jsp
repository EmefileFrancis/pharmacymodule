            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> View Institution</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            View Medical Institution
        </h1>
        <ol class="breadcrumb">
            <li><a href="<c:url value="/"/>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<c:url value="/"/>"></i> Dashboard</a></li>
            <li><a href="<c:url value="/addInstitution"/>">Add Institution</a></li>
            <li class="active">View Institution</li>
        </ol>
    </section>
                ...
                <div class="panel panel-default chartJs">
                    <div class="panel-heading">
                        <div class="card-title">
                            <div class="title">Search Medical Institutions</div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <div class="panel panel-default chartJs">
                    <div class="panel-heading">
                        <div class="card-title">
                            <div class="title">List of Medical Institutions</div>
                        </div>
                    </div>
                    <div class="panel-body">
